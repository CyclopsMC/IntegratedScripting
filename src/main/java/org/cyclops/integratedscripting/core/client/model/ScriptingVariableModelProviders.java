...
public class ScriptingVariableModelProviders {
    ...
    public static final SingleVariableModelProvider SCRIPT = REGISTRY.addProvider(new SingleVariableModelProvider(Identifier.fromNamespaceAndPath(Reference.MOD_ID, "customoverlay/script")));
